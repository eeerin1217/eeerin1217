...
const pawt = document.getElementById('pawt');
const cry = document.getElementById('cry');
const golat = document.getElementById('golat');
const diri = document.getElementById('diri');
const karay = document.getElementById('karay');
const tolog = document.getElementById('tolog');
